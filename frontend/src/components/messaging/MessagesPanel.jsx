...
// Panneau messagerie réutilisable — liste des conversations + fil de
// discussion. Extrait de MessagesPage pour être aussi embarquable dans
// n'importe quel dashboard à chrome propre (ex. DriverDashboard, qui n'utilise
// pas le <Navbar /> public et n'avait donc jusqu'ici aucun accès à la
// messagerie malgré le bouton "Contacter le livreur" côté acheteur).
export default function MessagesPanel({ className = '' }) {
